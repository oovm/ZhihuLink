...
Unprotect[ZhihuLink`PackageScope`Private`$TopLevelLoad];
ZhihuLink`PackageScope`Private`$TopLevelLoad=
...
PackageScopeBlock[e_,scope_String:"Package"]/;TrueQ[$AllowPackageRescoping]:=
	With[{newcont="ZhihuLink`PackageScope`"<>StringTrim[scope,"`"]<>"`"},
...
PackageDecontext[
	...
	With[{
		...
		ctx="ZhihuLink`PackageScope`"<>StringTrim[scope,"`"]<>"`"
		},
		Replace[names,
...
If[(Clear@ZhihuLink`PackageScope`Private`$loadAbort;!#)&@ZhihuLink`PackageScope`Private`$loadAbort,

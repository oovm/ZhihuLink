...
VerifyCookieStatus[cookie___]:=If[
	Length@{cookie}!=1||Head[cookie]=!=List||Length@cookie==0||Or@@((Head[#]=!=Association)&/@cookie),
	False,
	FreeQ[Quiet[
		Check[TimeConstrained[Keys@GeneralUtilities`ToAssociations[
			URLExecute[
				HTTPRequest[
...
ProcessRawCookie[cookieraw_String]:=Flatten@StringCases[
	StringSplit[cookieraw,";"],
	StartOfString~~name:Shortest[__]~~"="~~content__~~EndOfString:><|"Name"->StringDelete[name," "],
		"Content"->content|>
];
...
ImportCookies[]:=If[FileExistsQ@$ZhihuLinkCookieFile,
	BinaryDeserialize@Decrypt[GenerateSymmetricKey[Uncompress@"1:eJxTTMoPClZmYGAIycgsVgCikoxUhezUSoW0/CKF5Pz87MxUheKS/KLE9FRFACiWDlA=",Method->"RC4"],ByteArray@BinaryReadList@$ZhihuLinkCookieFile],
	$Failed
];
